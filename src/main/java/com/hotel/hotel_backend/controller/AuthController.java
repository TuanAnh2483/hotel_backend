...
public class AuthController {
    ...
    // Đăng ký gửi email xác minh, chưa cấp access token.
    ...
    // Endpoint công khai: client gửi token lấy từ link email.
    ...
    // Trả response chung để tránh lộ thông tin email nào tồn tại trong hệ thống.
